...
## Scenario 2: Admission Process Follow-Up

**Turn 1 — User**: "How do I take admission at PERC?"
**Answer**: The process is — (1) Book a free demo or counseling call, (2) Visit the campus in Begur, (3) Diagnostic assessment, (4) Choose the right program, (5) Complete formalities and start.
...
**Answer**: The diagnostic assessment is an internal test to understand the student's current academic level, identify strengths and areas needing improvement, and allocate the student to the most appropriate batch. It is not an entrance exam — no student is rejected based on it.

---

## Scenario 3: Class 8 Program Follow-Up

**Turn 1 — User**: "What courses are available for Class 8?"
**Answer**: For Class 8, PERC offers the PERC Challenger program — a 1-year course focused on challenging problems and deeper conceptual understanding in Maths and Science.

**Turn 2 — User**: "What subjects does it cover?"
**Context**: Referring to PERC Challenger.
**Answer**: PERC Challenger covers Mathematics and Science as the primary subjects, aligned with CBSE and ICSE board curricula for Class 8.
